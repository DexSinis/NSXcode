...
- (void)commonInit
{
    ...
    
    {
        ...
        sv.contentSize=CGSizeMake(sv.frame.size.width, kScreenHeight);
...
//        frame.size.height=MIN(frame.size.height, _viewMaxHeight+64);
        _svContainer.frame=kScreenBounds;
    }
    {
...
- (void)addTagToLast:(NSString *)tag{
    ...
    param.categoryname = tag;
    param.categoryid = @"8";
//    [NSXCategory categoryInsertWithParam:param success:^(NSXCategoryResult *categoryResult) {
